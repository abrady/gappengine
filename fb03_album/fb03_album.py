...
def obj_debug_str(obj):
	return pformat(inspect.getmembers(obj))
...
class HomeHandler(BaseHandler):
	def get(self):
		...
		if self.current_user:
			...
			albums = self.graph.get_connections(self.current_user.id, "albums")
			logging.debug("albums data: " + str(albums))
			for album in albums['data']:
				logging.debug("album " + album['name'] + ", num pics: " + album['count'])
#				for pic in album.images:
#					logging.debug("pic source: " + pic.source)					
